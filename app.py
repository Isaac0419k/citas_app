...
def guardar_paciente():
    try:
        ...
        return render_template("resultado.html",
                               ...
                               mensaje=f"El paciente {nombre} {apellido} fue registrado correctamente.")
...
def consultar_pac():
    try:
        ...
        return render_template("resultado_paciente.html", paciente=paciente)
    except Exception as e:
        return render_template("resultado.html",
                               tipo="error",
...
def guardar_cita():
    try:
        ...
        return render_template("resultado.html",
                               ...
                               mensaje="Tu cita fue reservada correctamente.")
    except Exception as e:
        return render_template("resultado.html",
                               tipo="error",
                               titulo="Error al reservar cita",
                               mensaje=str(e))
    ...
    try:
        ...
        if not cita:
            return render_template("resultado.html",
                                   ...
                                   mensaje=f"No existe una cita con ID {id}.")
...
def actualizar_cita_view():
    try:
        ...
        return render_template("resultado.html",
                               ...
                               mensaje="Los datos de la cita fueron actualizados correctamente.")
    except Exception as e:
        return render_template("resultado.html",
                               tipo="error",
